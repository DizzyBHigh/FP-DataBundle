...
/**
 * PlayerGameProjectedStats
 *
 * @ORM\Table(name="fd_playerGameProjectedStats")
 * @ORM\Entity(repositoryClass="FantasyPro\DataBundle\Entity\PlayerGameProjectedStatsRepository")
 */
class PlayerGameProjectedStats
{
    /**
     * @var integer
     *
