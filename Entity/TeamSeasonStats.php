 ...
 * TeamGameStats
 *
 * @ORM\Table(name="fp_teamSeasonStats")
 * @ORM\Entity(repositoryClass="FantasyPro\DataBundle\Entity\TeamSeasonStatsRepository")
 */
class TeamSeasonStats
{
     ...
     * @var integer
     *
     * @ORM\Column(type="integer", nullable=true, name="teamSeasonID")
     */
    private $teamSeasonID;
     ...
     */
    public function setTeamSeasonID( $teamSeasonID )
    {
