 ...
 * GameStatsBySeason
 *
 * @ORM\Table(name="fd_gameStatsBySeason")
 * @ORM\Entity(repositoryClass="FantasyPro\DataBundle\Entity\GameStatsBySeasonRepository")
 */
class GameStatsBySeason
{
    /**
     * @var integer
     *
     ...
     * @var string
     *
     * @ORM\Column(type="string", unique=true, length=50, nullable=false, name="gameKey")
     */
    private $gameKey;
     ...
     * @var string
     *
     * @ORM\Column(type="integer", unique=true, nullable=true, name="gameID")
     */
    private $gameID;
    ...
    */
     ...
     * @param string $gameKey
     */
    public function setGameID( $gameKey )
    {
        $this->gameKey = $gameKey;
    }
