 ...
 * GameLeagueLeaders
 *
 * @ORM\Table(name="fp_gameLeagueLeaders")
 * @ORM\Entity(repositoryClass="FantasyPro\DataBundle\Entity\GameLeagueLeadersRepository")
 */
class GameLeagueLeaders
{
    /**
     * @var integer
     *
     ...
     * @var string
     *
     * @ORM\Column(type="string", length=50, nullable=true, name="GameKey")
     */
    private $gameKey;
     ...
     * @var \DateTime
     *
     * @ORM\Column(type="datetime", nullable=true, name="gameDate")
     */
    private $gameDate;
     ...
     * @var string
     *
     * @ORM\Column(type="string", length=255, nullable=true, name="position")
     */
    private $position;
     ...
     * @var string
     *
     * @ORM\Column(type="decimal", nullable=true, name="receivingYardsPerTarget")
     */
     ...
     * @var integer
     *
     * @ORM\Column(type="integer", nullable=true, name="playerGameID")
     */
     ...
     * @var string
     *
     * @ORM\Column(type="decimal", nullable=true, name="puntNetAvergae")
     */
    private $puntNetAvergae;
     ...
     * @return string
     */
    public function getPuntNetAvergae()
    {
        return $this->puntNetAvergae;
    }

    /**
     * @param string $puntNetAvergae
     */
    public function setPuntNetAvergae( $puntNetAvergae )
    {
        $this->puntNetAvergae = $puntNetAvergae;
    }
