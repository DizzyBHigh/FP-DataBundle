...
class FantasyDefenseSeasonBuilder
{
    /**
    ...
    public function buildFantasyDefenseSeason( $currentFantasyDefenceSeason = null, $fantasydefenceseason )
    {
        if ( ! $currentFantasyDefenceSeason) {
            $currentFantasyDefenceSeason = new FantasyDefenseSeason();
        }
